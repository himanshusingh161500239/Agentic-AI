...
GEMINI_BASE_URL = "https://generativelanguage.googleapis.com/v1beta/openai/"
GEMINI_API_KEY = os.getenv("GEMINI_ACCESS_KEY") or None

gemini_client = AsyncOpenAI(base_url=GEMINI_BASE_URL, api_key=GEMINI_API_KEY)

MAX_TURNS = 30

# Utility to always return a Gemini model wrapper
...
class Trader:
    def __init__(self, name: str, lastname="Trader", model_name="gemini-1.5-flash"):
        self.name = name
        self.lastname = lastname
    ...
    async def get_account_report(self) -> str:
        account_data = await read_accounts_resource(self.name)
